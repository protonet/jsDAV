...
var jsDAV_FS_File = module.exports = jsDAV_FS_Node.extend(jsDAV_File, {
     ...
     * @return void
     */
    "delete": function(cbfsfiledel, systemUid) {
        if (typeof systemUid !== "undefined") {
            process.env.CURRENT_TRASH_USER = parseInt(systemUid);
            Fs.unlinkSync(this.path);
            process.env.CURRENT_TRASH_USER = null;
            cbfsfiledel();
        } else {
